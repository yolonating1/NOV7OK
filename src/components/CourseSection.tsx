  ...
  const toolCards = [
    {
      ...
      description: "Advanced SEO optimization and content creation platform. Create high-ranking content with AI-powered insights.",
      link: "https://app.neuronwriter.com/ar/b3a3b98151d0867de337d7e7f1be9a16",
      icon: <Search className="h-6 w-6" />
    },
    {
      title: "Rytr AI Writing",
      description: "Professional AI copywriting assistant for creating engaging content. Generate high-converting copy instantly.",
